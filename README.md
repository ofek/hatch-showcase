...
| | |
| --- | --- |
| CI/CD | [![CI - Test](https://github.com/ofek/hatch-showcase/actions/workflows/test.yml/badge.svg)](https://github.com/ofek/hatch-showcase/actions/workflows/test.yml) [![CI - Build](https://github.com/ofek/hatch-showcase/actions/workflows/build.yml/badge.svg)](https://github.com/ofek/hatch-showcase/actions/workflows/build.yml) [![CD - Publish](https://github.com/ofek/hatch-showcase/actions/workflows/publish.yml/badge.svg)](https://github.com/ofek/hatch-showcase/actions/workflows/publish.yml) |
